  ...
  <Layout>
    ...
    >
      ...
      <div class="loop-tabs js-loop-tabs container max-width-adaptive-lg">
        <div class="grid grid-gap-md flex-row-reverse@md">
          <div class="loop-tabs__content col-6@md flex flex-column flex-column-reverse@md justify-center@md text-center text-left@md">
            ...
            <ul class="loop-tabs__controls js-loop-tabs__controls margin-bottom-lg flex flex-center flex-wrap flex-column@md items-start@md">
              <li><a
                  href="#timingTab1Panel1"
                  class="loop-tabs__control loop-tabs__control--selected"
                >La création d’emplois non délocalisables</a></li>
              <li><a
                  href="#timingTab1Panel2"
                  class="loop-tabs__control"
                >La mise en réseaux des acteurs de la Restauration Hors Domicile à l’échelle transfrontalière</a></li>
              <li><a
                  href="#timingTab1Panel3"
                  class="loop-tabs__control"
                >De nouveaux marchés pour les producteurs locaux</a></li>
              <li><a
                  href="#timingTab1Panel4"
                  class="loop-tabs__control"
                >Une plus juste redistribution de la valeur ajoutée tout au long de la chaîne de production</a></li>
              <li><a
                  href="#timingTab1Panel5"
                  class="loop-tabs__control"
                >L’autonomie de la décision au niveau local</a></li>
              <li><a
                  href="#timingTab1Panel6"
                  class="loop-tabs__control"
                >Le meilleure alimentation dans la Restauration Hors Domicile.</a></li>
            </ul>

            <div class="loop-tabs__panels js-loop-tabs__panels margin-bottom-md">
              <section
                id="timingTab1Panel1"
                class="loop-tabs__panel js-loop-tabs__panel text-component loop-tabs__panel--selected"
              >
                <!-- <h3>La création d’emplois non délocalisables</h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, aperiam!</p> -->
              ...
              >
                <!-- <h3>La mise en réseaux des acteurs de la Restauration Hors Domicile à l’échelle transfrontalière.
              </h3>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, aperiam!</p> -->
              </section>
              ...
              <section
                ...
                class="loop-tabs__panel js-loop-tabs__panel text-component"
              >
                <!-- <h3>De nouveaux marchés pour les producteurs locaux
              </h3>
          ...
          >
            <ul
              class="loop-tabs__assets js-loop-tabs__assets"
              style="width:100%;height:100%"
            >
              <li
                class="loop-tabs__asset loop-tabs__asset--selected "
                style="background-image: url('assets/img/1.jpg');height: 100%;width: 100%;background-size: cover;"
              >

                <!-- <img src="/assets/img/1.jpg" alt="Feature 1 Preview"> -->

              </li>

              <li
                class="loop-tabs__asset"
                style="background-image: url('assets/img/2.jpg');height: 100%;width: 100%;background-size: cover;"
              ></li>
              <!-- <img src="/assets/img/2.jpg" alt="Feature 2 Preview"> -->

              <li
                class="loop-tabs__asset"
                style="background-image: url('assets/img/1.jpg'); height: 100%;width: 100%;background-size: cover;"
              ></li>
              <!-- <img src="/assets/img/1.jpg" alt="Feature 3 Preview"> -->

              <li
                class="loop-tabs__asset"
                style="background-image: url('assets/img/2.jpg');height: 100%;width: 100%;background-size: cover;"
              ></li>
              <!-- <img src="/assets/img/2.jpg" alt="Feature 4 Preview"> -->

              <li
                class="loop-tabs__asset"
                style="background-image: url('assets/img/1.jpg'); height: 100%;width: 100%;background-size: cover;"
              ></li>
              <!-- <img src="/assets/img/1.jpg" alt="Feature 5 Preview"> -->

              <li
                class="loop-tabs__asset"
                style="background-image: url('assets/img/2.jpg');height: 100%;width: 100%;background-size: cover;"
              ></li>
              <!-- <img src="/assets/img/2.jpg" alt="Feature 6 Preview"> -->
      ...
      <div class="container max-width-lg cd-timeline__container">
        ...
        <div class="cd-timeline__block">
          <div class="cd-timeline__img cd-timeline__img--movie">
            <!-- <img src="assets/img/1.jpg" alt="Movie"> -->
          </div> <!-- cd-timeline__img -->
        ...
        <div class="cd-timeline__block">
          <div class="cd-timeline__img cd-timeline__img--location">
            <!-- <img src="assets/img/1.jpg" alt="Location"> -->
          </div> <!-- cd-timeline__img -->
