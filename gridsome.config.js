  ...
  plugins: [
    {
      ...
      options: {
        ...
        params: {
          resolve_links: 'story',
          resolve_relations: 'navigation, preview-articles.articles, page-map.organisations,partners.partners,partners.poweredby,existing_element.element,articles,footer'
        },
